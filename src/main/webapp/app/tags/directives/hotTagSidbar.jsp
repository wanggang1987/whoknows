	    	 ...
	    	 <div class="list-group">
	    	 	<div class="list-group-item row" ng-repeat="tag in tags">
	    	 		...
	    	 		<div class="col-md-9">
			    		...
			    		<p class="list-group-item-text"><a href="javascript:void(0);" ng-click="fllowTag(tag)" class="font-gray-color"><span class="glyphicon glyphicon-heart"></span><span ng-hide="tag.cancelFllow">关注</span><span ng-show="tag.cancelFllow">取消关注</span></a>({{tag.follow}})</p>
